    ...
    <div className="min-h-screen pt-24 pb-16 px-6 bg-[var(--bg-primary)]">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-slate-500 dark:text-gray-400">Last updated: April 8, 2026</p>
        </motion.div>
        ...
        <div className="space-y-12">
          ...
          <section className="glass-panel p-8 border-[#3b82f6]/20">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Our Data Philosophy</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-slate-50 dark:bg-white/5 p-4 rounded-xl border border-slate-200 dark:border-white/10">
                ...
                <p className="text-xs text-slate-500 dark:text-gray-500">All uploaded CSV/Excel files are processed in-memory and are never written to a permanent database.</p>
              </div>
              <div className="bg-slate-50 dark:bg-white/5 p-4 rounded-xl border border-slate-200 dark:border-white/10">
                <h3 className="text-slate-900 dark:text-white font-semibold mb-2 flex items-center gap-2">
                  <Trash2 className="w-4 h-4 text-red-400" /> Auto-Deletion
                </h3>
                <p className="text-xs text-slate-500 dark:text-gray-500">Session data is automatically cleared once your audit is complete or your session expires.</p>
              </div>
            </div>
          </section>

          {/* Detailed Content */}
          <section className="prose dark:prose-invert max-w-none text-slate-600 dark:text-gray-400 space-y-6">
            <div>
              <h3 className="text-slate-900 dark:text-white text-xl font-bold mb-4">1. Data We Collect</h3>
              <p>
            ...
            <div>
              <h3 className="text-slate-900 dark:text-white text-xl font-bold mb-4">4. Security</h3>
              <p>
